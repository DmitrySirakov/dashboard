...
if authentication_status:
    ...
    df_3 = (
        df_selection.query("`Этап ассесмента` == 3 & Статус == @status")[
    ...
    df_2 = (
        df_selection.query("`Этап ассесмента` == 2 & Статус == @status")[
            ["Слушатель", "Наименование компетенции", "Результат", "Этап ассесмента"]
        ]
        .drop_duplicates()
        .groupby(["Наименование компетенции", "Этап ассесмента"], as_index=False)
    ...
    df_1 = (
        df_selection.query("`Этап ассесмента` == 1 & Статус == @status")[
            ["Слушатель", "Наименование компетенции", "Результат", "Этап ассесмента"]
        ]
        .drop_duplicates()
        .groupby(["Наименование компетенции", "Этап ассесмента"], as_index=False)
