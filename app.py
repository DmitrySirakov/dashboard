...
def get_data_from_cloud(n_list=0):
    ...
    df = df.replace(['Использует специальные технические программы CAD/CAM проектированээя',
 'Использует специальные технические программы CAD/CAM проектирээвания',
 'Используээт специальные технические программы CAD/CAM проектирования',
 'Использээет 3D-моделирование', 'Исээользует большие данные',
 'Осуществляет сбор и подготовку данных для обучения моделей искусственного интелээекта',
 'Осуществляет сбор и подготовку данных для обучения моделей искусственнээго интеллекта',
 'Осуществляет сбор и подготовку данных для обучения моделей искуээственного интеллекта',
 'Осуществляет сбор и подготовку даннээх для обучения моделей искусственного интеллекта',
 'Осуществляет сбор и подготовээу данных для обучения моделей искусственного интеллекта',
 'Осуществляет сбор и ээодготовку данных для обучения моделей искусственного интеллекта',
 'Осуществляет сбор ээ подготовку данных для обучения моделей искусственного интеллекта',
 'Применээет языки программирования для решения профессиональных задач',
 'Применяет СээБД', 'Применяет интегрированные среды разработээи (IDE)',
 'Применяет интегрированные среды разрабоээки (IDE)',
 'Применяет интегрированные срээды разработки (IDE)',
 'Применяет интегриээованные среды разработки (IDE)',
 'Применяет инээегрированные среды разработки (IDE)',
 'Применяет искээсственный интеллект и машинное обучение',
 'Применяет исээусственный интеллект и машинное обучение',
 'Применяет математический аппарат для решения задач по оценке и разработки моделеээ',
 'Применяет математический аппарат для решения задач по оценке и разраээотки моделей',
 'Применяет математический аппарат для решения задач по оценке и ээазработки моделей',
 'Применяет математический аппарат для решения задач по оцеээке и разработки моделей',
 'Применяет математический аппарат для решеээия задач по оценке и разработки моделей',
 'Применяет математический аппарээт для решения задач по оценке и разработки моделей',
 'Применяет принципы и основы алгоритмиээации',
 'Применяет принципы и основы алээоритмизации',
 'Применяет принципы и оээновы алгоритмизации',
 'Применяет принциээы и основы алгоритмизации',
 'Применяет принцээпы и основы алгоритмизации',
 'Применяет приээципы и основы алгоритмизации',
 'Применяет ээринципы и основы алгоритмизации',
 'Применяет ээскусственный интеллект и машинное обучение',
 'Применяет языки программирования длээ решения профессиональных задач',
 'Применяет языки программирования для решения профессиональных задаээ',
 'Применяет языки программирования для решения проээессиональных задач',
 'Применяет языки программирования для решения пээофессиональных задач',
 'Применяет языки программирования для решээния профессиональных задач',
 'Применяет языки программирования для рээшения профессиональных задач',
 'Применяет языки программирования ээля решения профессиональных задач',
 'Применяет языки программиээования для решения профессиональных задач',
 'Применяет языки прогрээммирования для решения профессиональных задач',
 'Применяет языээи программирования для решения профессиональных задач',
 'Применяет яээыки программирования для решения профессиональных задач',
 'Примээняет математический аппарат для решения задач по оценке и разработки моделей',
 'Приээеняет принципы и основы алгоритмизации',
 'Пээименяет интегрированные среды разработки (IDE)',
 'Пээименяет языки программирования для решения профессиональных задач',
 'Разрабатывает и применяет методы машинээого обучения (МО) для решения задач',
 'Разрабатывает и применяет методы машиээного обучения (МО) для решения задач',
 'Разрабатывает и применяет методы машээнного обучения (МО) для решения задач',
 'Разрабатывает и применяет методы маээинного обучения (МО) для решения задач',
 'Разрабатывает и применяет методы мээшинного обучения (МО) для решения задач',
 'Разрабатывает и применяет мээтоды машинного обучения (МО) для решения задач',
 'Разрабатывает программноээ обеспечение',
 'Разрабатыээает программное обеспечение',
 'Разээабатывает программное обеспечение',
 'Решает задачи искусственного ээнтеллекта (ИИ)',
 'Решает задээчи искусственного интеллекта (ИИ)', 
 'ээрименяет языки программирования для решения профессиональных задач'],
   ['CAD/CAM']* 3 + ['3D', 'BigData'] + ['Сбор данных']*7 + ['ЯП', 'СУБД'] + ['IDE'] * 5 + ['ИИ'] * 2 + ['Математика'] * 6 + ['Алгоритмы'] * 7 + ['ИИ'] + ['ЯП'] * 11 + ['Математика',  'Алгоритмы', 'IDE', 'ЯП'] + ['ML'] * 6 + ['ПО'] * 3 + ['Практика ИИ'] * 2 + ['ЯП']) 
    df = df.replace(['Применяет математический аппээрат для решения задач по оценке и разработки моделей',
 'Применяет ээзыки программирования для решения профессиональных задач',
 'Применяет языки программирования для решения профессиональнээх задач',
 'Применяет языки программироваээия для решения профессиональных задач',
 'Применяет языки программээрования для решения профессиональных задач',
 'Применяет языки прээграммирования для решения профессиональных задач',
 'Применяет языки ээрограммирования для решения профессиональных задач',
 'Примээняет языки программирования для решения профессиональных задач',
 'Разрабатывает и применяет методы машинного обучения (МО) для решенээя задач'], ['Математика'] + ['ЯП'] * 7 + ['ML'])
