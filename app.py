...
def get_data_from_cloud(n_list=0):
    ...
    df = df.replace(['Использует 3D-моделирование', 'Использует 3D-моделированээе',
       'Используеээ специальные технические программы CAD/CAM проектирования',
       'Осуществляет сбор и подготовку данных для обучения моделей искусственного интеллээкта',
       'Осуществляет сбор и подготовку данных для обучения моделей искусственного ээнтеллекта',
       'Осуществляет сбор и подготовку данных для обучения моделей иээкусственного интеллекта',
       'Осуществляет сбор и подготовку данных для обучения моээелей искусственного интеллекта',
       'Осуществляет сбор и подготовку данных для обучээния моделей искусственного интеллекта',
       'Осуществляет сбор и подготовку данныээ для обучения моделей искусственного интеллекта',
       'Применяет интегрированные среды разработки (IDE)',
       'Применяет интээгрированные среды разработки (IDE)',
       'Применяет искусственээый интеллект и машинное обучение',
       'Применяет искуээственный интеллект и машинное обучение',
       'Применяет математический аппарат для решения задач по оценке и разработээи моделей',
       'Применяет математический аппарат для решения задач по ээценке и разработки моделей',
       'Применяет математический аппарат для решенээя задач по оценке и разработки моделей',
       'Применяет математический аппээрат для решения задач по оценке и разработки моделей',
       'Применяет матеээатический аппарат для решения задач по оценке и разработки моделей',
       'Применяет принципы и основы алгориээмизации',
       'Применяет принципы и основы ээлгоритмизации',
       'Применяет прээнципы и основы алгоритмизации',
       'Применяет пээинципы и основы алгоритмизации',
       'Применяет ээзыки программирования для решения профессиональных задач',
       'Применяет языки программированиээ для решения профессиональных задач',
       'Применяет языки программирования для решения профессиональных задач',
       'Применяет языки программирования для решения профессиональных ээадач',
       'Применяет языки программирования для решения профессиональнээх задач',
       'Применяет языки программирования для решения профессионалээных задач',
       'Применяет языки программирования для решения профессиоээальных задач',
       'Применяет языки программирования для решения профессиээнальных задач',
       'Применяет языки программирования для решения професээиональных задач',
       'Применяет языки программирования для решения профеээсиональных задач',
       'Применяет языки программирования для решения профээссиональных задач',
       'Применяет языки программирования для решения прээфессиональных задач',
       'Применяет языки программирования для ээешения профессиональных задач',
       'Применяет языки программирования дээя решения профессиональных задач',
       ...
       'Применяет языки пээограммирования для решения профессиональных задач',
       'Применяет языки ээрограммирования для решения профессиональных задач',
       'Применяеээ языки программирования для решения профессиональных задач',
       'Примеээяет интегрированные среды разработки (IDE)',
       'Примеээяет искусственный интеллект и машинное обучение',
       'Примээняет языки программирования для решения профессиональных задач',
       'Прээменяет интегрированные среды разработки (IDE)',
       'Разрабатывает и применяет методы машинного обучения (МО) для решениээ задач',
       'Разрабатывает и применяет методы машинного обучения (МО) для решения задач',
       'Разрабатывает и применяет методы машинного обучения (МО) для решенээя задач',
       'Разрабатывает и применяет методы машинного обээчения (МО) для решения задач',
       'Разрабатывает и примээняет методы машинного обучения (МО) для решения задач',
       'Разрабатывает программное обеспечение',
       'Разрабатывает программное обеспечеээие',
       'Разрабатываеээ программное обеспечение',
       'Решает задачи искусственного интеллекта (ИИ)',
       'Решает задачи искусственного интеллектээ (ИИ)',
       'Решает задачи ээскусственного интеллекта (ИИ)',
       'Рээзрабатывает программное обеспечение',
       'ээешает задачи искусственного интеллекта (ИИ)'],
       ['3D', '3D','CAD/CAM'] +['Сбор данных'] * 6 + ['IDE'] * 2 + ['ИИ'] * 2 + ['Математика'] * 5 + ['Алгоритмы'] * 4 + ['ЯП'] * 20 + ['IDE', 'ИИ', 'ЯП', 'IDE'] + ['ML'] * 5 + ['ПО'] * 3 +['практика ИИ'] * 3 + ['ПО', 'практика ИИ'])
